...
public class OnlineLDAOptimizer {
    ...
    /**
     * function to generate gamma function
     *
     * @param rows
     * @param cols
     * @return new gamma matrix
     */
    ...
    OnlineLDAOptimizer next() {
        ...
        //sample mini batch with the size of miniBatchFraction
    ...
    /**
     * creates the LDA model after all iterations
     *
     * @return
     */
    ...
    /**
     * Main function for submitting miniBatch
     *
     * @param batch
     * @return
     * @throws Exception
    ...
    OnlineLDAOptimizer submitMiniBatch(DataSet<Tuple2<Long, DenseVector>> batch) throws Exception {
        ...
        //caculate the local parameters in parralell
        ...
        //Get only matrices, here we don't use vectors as they are for optimization and don't play role in the original algorithm
        ...
        try {
            ...
            //update global topic matrix with batch result
    ...
    /**
     * funtion for updating global topic matrix after each iteration
     *
     * @param stat
     * @param batchSize
     */
    ...
    public static class batchMapper extends RichMapPartitionFunction<Tuple2<Long, Tuple2<Long, DenseVector>>, Tuple2<HashMap<Long, DenseVector>, DenseMatrix>> {
        ...
        /**
         * get all the parameters from the global enviroment
         *
         * @param parameters
         */
        ...
        public void mapPartition(Iterable<Tuple2<Long, Tuple2<Long, DenseVector>>> docs, Collector<Tuple2<HashMap<Long, DenseVector>, DenseMatrix>> collector) throws Exception {
            ...
            for (Tuple2<Long, Tuple2<Long, DenseVector>> doc : docs) {
                ...
                //the main method of cumputing the numbers
